...
* @e_ident: A pointer to array containing the magic number.
*
...
/**
* print_entry - Print an entry point of ELF header.
...
* @argv: An array of pointers to a argument.
*
* Return: 0 on success.
*
